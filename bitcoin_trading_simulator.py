...
def simulate_bitcoin_prices(days=60, initial_price=50000.0, volatility=0.04, drift=0.001):
    ...
    # Use Generator for secure randomness
    ...
    dates = pd.date_range(end=pd.Timestamp.now(tz='UTC'), periods=days)
...
if __name__ == "__main__":
    ...
    print(out_df[['Date', 'Price', 'MA7', 'MA30', 'Action', 'Portfolio Value']].to_string(index=False))
